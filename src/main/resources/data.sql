...
INSERT INTO book (name, description, author, page_count, price, language, publish_date, register_date, library_id,
                  librarian_id)
VALUES ('The Great Gatsby', 'A classic novel set in the 1920s, exploring themes of wealth and excess.',
        'F. Scott Fitzgerald', 180, 15.99, 'English', '1925-04-10', '2024-12-18 10:00:00', 1, 1),
       ('1984', 'A dystopian social science fiction novel and cautionary tale about the future.', 'George Orwell', 328,
        12.49, 'English', '1949-06-08', '2024-12-18 10:10:00', 1, 1),
       ('To Kill a Mockingbird', 'A novel about racial injustice in the Deep South.', 'Harper Lee', 281, 14.29,
       ...
       ('Pride and Prejudice', 'A romantic novel of manners that depicts the British landed gentry.', 'Jane Austen',
        279, 9.99, 'English', '1813-01-28', '2024-12-18 10:30:00', 1, 1);

insert into users
    (username, password, enabled)
values ('elgin', '{noop}elgin1', 1),
       ('test1', '{noop}test1', 1),
       ('test2', '{noop}test2', 1);
--     ('alici2','{noop}1234',1);
